...
public class MapFragment extends BaseFragment implements View.OnClickListener, AMap.InfoWindowAdapter {
    ...
    private void setUpMap(String s) {
        aMap.moveCamera(CameraUpdateFactory.newCameraPosition(new CameraPosition(Constants.INSTANCE.getSHANGHAI(), 18, 0, 0)));
    ...
    public void onClick(View v) {
        AddNewGasUserActivity.Companion.toActivity(getContext());
    }
