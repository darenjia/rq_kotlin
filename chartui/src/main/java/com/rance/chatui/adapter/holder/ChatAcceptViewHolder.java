...
import com.rance.chatui.util.GlideUtil;
...
//        Glide.with(mContext).load(data.getHeader()).apply(GlideUtil.getRequestOption()).into(chatItemHeader);
        ...
        switch (data.getFileType()) {
            ...
            case Constants.CHAT_FILE_TYPE_IMAGE:
                ...
                Glide.with(mContext).load(data.getFilepath()).apply(GlideUtil.getRequestOption()).into(chatItemContentImage);
...
//                chatItemLayoutContent.setVisibility(View.VISIBLE);
            ...
            case Constants.CHAT_FILE_TYPE_LINK:
                ...
                Glide.with(mContext).load(link.getStream()).apply(GlideUtil.getRequestOption()).into(ivLinkPicture);
                break;
        }
    }
